<%@ Page Title="" Language="C#" MasterPageFile="~/admin/masterpage/MasterPage.master" AutoEventWireup="true" CodeFile="BrandList.aspx.cs" Inherits="admin_shop_BrandList" %>
                        ...
                        <asp:GridView runat="server" AutoGenerateColumns="False" Width="100%" ID="GridView1"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="分類">
                                    <ItemTemplate>
                                        <asp:Label ID="lblClassify" runat="server" Text=""></asp:Label>
                                    </ItemTemplate>
