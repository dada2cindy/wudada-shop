<%@ Page Title="" Language="C#" MasterPageFile="~/admin/masterpage/MasterPage.master" AutoEventWireup="true" CodeFile="Ad3_Detail.aspx.cs" Inherits="admin_adInfo_Ad3_Detail" %>
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="updateDataTable">
                                ...
                                <tr>
                                    ...
                                    <td class="updateDateContent">
                                        ...
                                        <asp:Label ID="Label11" runat="server" CssClass="labelAlert" Text="最佳大小(寬：250)"></asp:Label>
