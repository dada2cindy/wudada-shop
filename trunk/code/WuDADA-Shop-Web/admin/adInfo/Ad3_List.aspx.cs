...
public partial class admin_adInfo_Ad3_List : BasePage
{
    string JsStr = "";
    readonly string LIST_URL = "Ad3_List.aspx";
    readonly string DETAIL_URL = "Ad3_Detail.aspx";
    readonly int PARAM_ID_CLASSIFY = VarHelper.WuDADA_ITEMPARAM_ID_AD_INFO3;
