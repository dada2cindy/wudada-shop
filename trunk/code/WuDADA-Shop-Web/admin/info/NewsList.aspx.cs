...
public partial class admin_info_NewsList : BasePage
{
    string JsStr = "";
    readonly string LIST_URL = "NewsList.aspx";
    readonly string DETAIL_URL = "NewsDetail.aspx";
    ...
    protected void imgbtnSearch_Click(object sender, ImageClickEventArgs e)
    {
        ...
        GridView1.DataSource = myService.ExecutableDetachedCriteria<NewsVO>(dCriteria, startIndex, maxRecord);
        GridView1.DataBind();
    }
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        switch (e.CommandName)
        {
            case "MyEdit":
                ...
                break;
            case "MyDel":
                NewsVO newsVO = myService.DaoGetVOById<NewsVO>(int.Parse(e.CommandArgument.ToString()));
                myService.DaoDelete(newsVO);
                imgbtnSearch_Click(null, null);
