<%@ Page Title="" Language="C#" MasterPageFile="~/admin/masterpage/MasterPage.master" AutoEventWireup="true" CodeFile="ProductList.aspx.cs" Inherits="admin_shop_ProductList" %>
                            ...
                            <table width="100%" border="0" cellpadding="5" cellspacing="0">
                                ...
                                <tr>
                                    <td height="30px">
                                        ...
                                        &nbsp;&nbsp;
                                        商品編號：
                                        <asp:TextBox ID="txtSearch2" runat="server" Width="190px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td height="30px">
                        ...
                        <asp:GridView runat="server" AutoGenerateColumns="False" Width="100%" ID="GridView1"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="分類">
                                    <ItemTemplate>
                                        <asp:Label ID="lblClassify" runat="server" Text='<%# Eval("GetStr_ClassifyList") %>'></asp:Label>
                                    </ItemTemplate>
