<%@ Page Title="" Language="C#" MasterPageFile="~/admin/masterpage/MasterPage.master" AutoEventWireup="true" CodeFile="InfoList.aspx.cs" Inherits="admin_info_InfoList" %>
                        ...
                        <asp:GridView runat="server" AutoGenerateColumns="False" Width="100%" ID="GridView1"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="發布日期">
                                    <ItemTemplate>
                                        <asp:Label ID="lblUpdateTime" runat="server" Text='<%#Eval("UpdateTime","{0:yyyy/MM/dd}") %>'></asp:Label>
                                    </ItemTemplate>
