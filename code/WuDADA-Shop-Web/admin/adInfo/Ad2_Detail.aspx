<%@ Page Title="" Language="C#" MasterPageFile="~/admin/masterpage/MasterPage.master" AutoEventWireup="true" CodeFile="Ad2_Detail.aspx.cs" Inherits="admin_adInfo_Ad2_Detail" %>
                                ...
                                <tr>
                                    ...
                                    <td class="updateDateContent">
                                        <asp:RadioButtonList ID="rdoTarget" runat="server" RepeatDirection="Horizontal" Width="180px">
                                            <asp:ListItem Text="另開新視窗" Value="_blank" Selected="True"></asp:ListItem>
                                            <%--<asp:ListItem Text="直接連結" Value="_self"></asp:ListItem>--%>
                                        </asp:RadioButtonList>
                                    </td>
                                </tr>
                                <tr>
