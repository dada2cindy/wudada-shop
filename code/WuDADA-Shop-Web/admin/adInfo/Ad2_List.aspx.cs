...
public partial class admin_adInfo_Ad2_List : BasePage
{
    string JsStr = "";
    readonly string LIST_URL = "Ad2_List.aspx";
    readonly string DETAIL_URL = "Ad2_Detail.aspx";
    readonly int PARAM_ID_CLASSIFY = VarHelper.WuDADA_ITEMPARAM_ID_AD_INFO2;
