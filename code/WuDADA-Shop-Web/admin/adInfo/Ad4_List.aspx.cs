...
public partial class admin_adInfo_Ad4_List : BasePage
{
    string JsStr = "";
    readonly string LIST_URL = "Ad4_List.aspx";
    readonly string DETAIL_URL = "Ad4_Detail.aspx";
    readonly int PARAM_ID_CLASSIFY = VarHelper.WuDADA_ITEMPARAM_ID_AD_INFO4;
