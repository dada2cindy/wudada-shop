    ...
    protected void Repeater1_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if (e.Item.ItemIndex != -1)
        {
            ...
            if (fileVO != null)
            {
                ...
                UIHelper.SetLiteralText(ctrl, "ltlPic", string.Format("<li {0}><table style='border-width: 0px'><tr><td width='100%' align='left' style='border-width: 0px'><p class='txt-normal'>{7}</p><a href='../poss/product_detail.aspx?id={1}&cid={2}&bid={3}&bType={4}'><img src='{5}?type=fjx&fileName={6}&auto=h&size=120' alt=''/></a></td></tr></table></li>"
